...
export function Features() {
  return (
    <div className="max-w-6xl mx-auto p-6 lg:py-8">
      <h3 className="text-2xl lg:text-6xl font-bold">Key features</h3>
      <p className="max-w-lg mt-5 lg:mt-5 lg:mb-10 text-xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-5">
        {dataFeatures.map(({ icon: Icon, text, bg, delay }) => (
          <Reveal
            key={text}
            className="p-6 rounded-lg hover:shadow-lg flex flex-col items-center"
            position="right"
            delay={delay}
          >
            <div
